...
$RepoUrlSsh = "git@github.com:lyy0709/hermes-agent-zh.git"
$RepoUrlHttps = "https://github.com/lyy0709/hermes-agent-zh.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (Test-Path $InstallDir) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/lyy0709/hermes-agent-zh/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/lyy0709/hermes-agent-zh/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
