...
# ============================================================================
# 基于上游官方安装脚本，安装中文翻译版 hermes-agent。
# 翻译由 CI 自动完成并推送到 release 分支，安装体验与官方一致。
#
# Usage:
...
# Configuration
REPO_URL_SSH="git@github.com:lyy0709/hermes-agent-zh.git"
REPO_URL_HTTPS="https://github.com/lyy0709/hermes-agent-zh.git"
