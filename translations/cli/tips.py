...
TIPS = [
    ...
    "/branch 分叉当前会话，以便您可以探索不同方向而不丢失进度。",
    ...
    "hermes chat -t web,terminal 仅为聚焦会话启用特定工具集。",
    ...
    "仓库根目录中的 .worktreeinclude 列出了要复制到工作树中的 gitignored 文件。",
    ...
    # --- 隐藏宝石与高级用户技巧 ---
    "~/.hermes/BOOT.md 中的 BOOT.md 在每次消息网关启动时自动运行 — 将其用于启动检查。",
    ...
    "config.yaml 中的 context.engine 可以设置为插件名称，以使用替代的上下文管理策略。",
    ...
    "长危险命令（>70 个字符）在批准提示中获得“查看”选项，以便先查看完整文本。",
