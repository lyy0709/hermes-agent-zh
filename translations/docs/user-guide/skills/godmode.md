...
使用来自 [Pliny the Prompter](https://x.com/elder_plinius) (elder-plinius) 的 [G0DM0D3](https://github.com/elder-plinius/G0DM0D3) 和 [L1B3RT4S](https://github.com/elder-plinius/L1B3RT4S) 的技术，绕过 API 服务的 LLM 的安全过滤器。
...
G0DM0D3 是一个开源的越狱工具包，通过三种互补的攻击模式自动化绕过 LLM 安全过滤器。它由 Pliny the Prompter 创建，将 L1B3RT4S 集合中经过实战检验的越狱模板打包成可运行的脚本，并集成了自动化策略选择、评分和 Hermes 原生配置。
