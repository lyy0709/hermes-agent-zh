---
title: "Notion — 通过 curl 创建和管理页面、数据库及区块的 Notion API"
sidebar_label: "Notion"
description: "通过 curl 创建和管理页面、数据库及区块的 Notion API"
---
...
通过 curl 使用 Notion API 来创建和管理页面、数据库及区块。直接从终端搜索、创建、更新和查询 Notion 工作区。
...
通过 curl 使用 Notion API 来创建、读取、更新页面、数据库（数据源）和区块。无需额外工具——只需 curl 和 Notion API 密钥。
...
`Notion-Version` 请求头是必需的。此技能使用 `2025-09-03`（最新版本）。在此版本中，数据库在 API 中被称为 "data sources"。
