...
| | |
|---|---|
| 来源 | Optional — 使用 `hermes skills install official/gaming/minecraft-modpack-server` 安装 |
...
max-tick-time=180000       # 模组化服务器在生成世界时通常需要更长的 tick 超时
...
- `max-tick-time=180000` 或更高 — 模组化服务器在生成世界时通常有较长的 tick
