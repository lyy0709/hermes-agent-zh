...
description: "Parallel CLI 的可选供应商技能 —— 面向 Agent 的原生网络搜索、提取、深度研究、数据增强、FindAll 和监控"
---
...
Parallel CLI 的可选供应商技能 —— 面向 Agent 的原生网络搜索、提取、深度研究、数据增强、FindAll 和监控。优先使用 JSON 输出和非交互式流程。
