...
### 文本消息
发送和接收 iMessage。Markdown 会自动被清除，以确保干净的纯文本交付。
...
### Tapback 反应
支持爱心、点赞、点踩、大笑、强调和疑问反应。需要 BlueBubbles [Private API helper](https://docs.bluebubbles.app/helper-bundle/installation)。
