...
- **[技能系统](skills.md)** — Agent 在需要时可以加载的按需知识文档。技能遵循渐进式披露模式以最小化 Token 使用，并与 [agentskills.io](https://agentskills.io/specification) 开放标准兼容。
...
- **[提供商路由](provider-routing.md)** — 精细控制由哪个 AI 提供商处理您的请求。通过排序、白名单、黑名单和优先级排序，针对成本、速度或质量进行优化。
