...
- **只是随便看看？** 查看[关键功能概览](#key-features-at-a-glance)表格，快速了解 Hermes Agent 的所有功能。
...
:::tip
定时任务让 Hermes Agent 可以按计划运行任务——每日摘要、定期检查、自动报告——而无需您在场。
:::
...
:::tip
对于大多数自定义工具创建，请从插件开始。[添加工具](/docs/developer-guide/adding-tools)页面适用于 Hermes 核心内置开发，而不是通常的用户/自定义工具路径。
:::
...
- **对基础知识感到满意？** → 探索[工具](/docs/user-guide/features/tools)、[技能](/docs/user-guide/features/skills)和[记忆](/docs/user-guide/features/memory)以解锁 Agent 的全部功能。
...
- **想要实际示例？** → 查看[指南](/docs/guides/tips)部分，获取真实世界的项目和技巧。

:::tip
您不需要阅读所有内容。选择与您目标匹配的路径，按顺序点击链接，您很快就能上手。您可以随时返回此页面寻找下一步。
:::