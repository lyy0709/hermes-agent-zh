...
| [`macos-computer-use`](/docs/user-guide/skills/bundled/apple/apple-macos-computer-use) | 在后台驱动 macOS 桌面——截图、鼠标、键盘、滚动、拖拽——而不会窃取用户的鼠标光标、键盘焦点或 Space。适用于任何支持工具使用的模型。每当 `computer_use` 工具被...时加载此技能。 | `apple/macos-computer-use` |
