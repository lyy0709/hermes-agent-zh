...
| [`claude-design`](/docs/user-guide/skills/bundled/creative/creative-claude-design) | 设计一次性的 HTML 制品（落地页、演示文稿、原型）。 | `creative/claude-design` |
...
| [`pretext`](/docs/user-guide/skills/bundled/creative/creative-pretext) | 在使用 @chenglou/pretext 构建创意浏览器演示时使用——无 DOM 文本布局，用于 ASCII 艺术、围绕障碍物的排版流、文本作为几何图形的游戏、动态排版和文本驱动的生成艺术。生成单文件 HT... | `creative/pretext` |
